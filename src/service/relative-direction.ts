...
export interface RelativeDirection {
   ...
   * การทดลองภาคสนาม 10 คู่ / 200 ภาพ ตอบทิศถูกเพียง 2 จาก 10 คู่ (20.0%) ซึ่งไม่ต่าง
   * จากการเดาสุ่มของปัญหาสี่ทิศ (25.0%) อย่างมีนัยสำคัญ
 ...
 *     ของสิ่งที่ต้องการวัด สัญญาณต่อสิ่งรบกวนจึงใกล้ 1 และทิศที่ได้ถูก 2 จาก 10 คู่
...
export class RelativeDirectionUtil {
   ...
   * จนพ้นเขตสัญญาณรบกวน อีก 8 คู่ทิศที่คำนวณได้เป็นการเดาล้วน — และผลตอบทิศทั้งชุด
   * ถูกเพียง 2 จาก 10 คู่ ซึ่งไม่ต่างจากการเดาสุ่ม
   *
