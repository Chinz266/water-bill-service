 ...
 *
 * ผลคือคนที่เดินจดถูกต้องทุกขั้นตอนจะโดนด่าน "ยืนที่เดิมกดชัตเตอร์รัว" ทุกครั้ง
 * เทสต์ชุดนี้ล็อกไว้ว่าด่านนั้นต้องข้ามให้กลุ่มนี้ (ส่วนด่านพิกัดซ้ำเป๊ะถูกถอดออกทั้งระบบแล้ว)
...
describe('BillsService — กลุ่มมิเตอร์ที่ติดกัน', () => {
  ...
  describe('ด่านที่ตัดสินด้วยระยะทาง', () => {
    ...
    it('พิกัดตรงเป๊ะกับเพื่อนบ้านในกลุ่ม → ผ่าน (ไม่มีด่านที่ดูพิกัดซ้ำแล้ว)', async () => {
      storedReadings = [
        {
          id: 52,
          members_id: 3,
